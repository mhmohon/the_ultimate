...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
            	{!! Form::open(['route'=>['updateTopic',$topic->id],'class'=>'form-horizontal','files' => true]) !!}
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group {{ $errors->has('topic_title') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    ...
                                    value="{{ $topic->title }}" data-validation="length" data-validation-length="3-255" 
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group form-float {{ $errors->has('topic_des') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    ...
                                    data-validation="required">{{ $topic->description }}</textarea>
					...
					<div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    <input type="text" id="start_date" name="start_date" class="datepicker form-control" placeholder="Please choose a date" value="{{ $topic->start_date }}" data-validation="required">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group {{ $errors->has('closure_date') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    <input type="text" id="closure_date" name="closure_date" class="datepicker form-control" placeholder="Please choose a date" value="{{ $topic->closure_date }}" data-validation="required">
					...
					<div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group {{ $errors->has('final_date') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    <input type="text" id="final_date" class="datepicker form-control" name="final_date" placeholder="Please choose a date" value="{{ $topic->end_date }}" data-validation="required">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            ...
                            {!! Form::select('status',['1'=>'Active','0'=>'Deactive','2'=>'Closed'],$topic->status,['class'=>'form-control show-tick','required','id'=>'status','placeholder'=>'Please select Status','data-validation'=>'required']) !!}
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect">Update Topic</button>
