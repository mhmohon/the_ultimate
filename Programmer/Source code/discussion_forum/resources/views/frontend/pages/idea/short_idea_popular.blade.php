                ...
                <div class="post">
                    ...
                    <div class="postinfobot">
                       ...
                       <div class="posted pull-left">
                           <i class="fa fa-user-o"></i> {{ $idea->name }} &nbsp <i class="fa fa-clock-o"></i> {{ \Carbon\Carbon::parse($idea->created_at)->diffForHumans()}} &nbsp <i class="fa fa-eye"></i> {{ number_format($idea->view) }}
                       </div>
                        <!-- idea title -->
